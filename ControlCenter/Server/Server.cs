    ...
    class Server
    {
        ...
        public async Task Start()
        {
            ...
            while (true)
            {
                ...
                Debug.WriteLine($"Success Client Connected");
                ...
                while (true)
                {
                    ...
                    */
                    ...
                    foreach (Packet packet in session.ExtractPackets())
                    {
                        ...
                        Debug.WriteLine($"[RECV] IP :{((IPEndPoint)client.Client.RemoteEndPoint).ToString()} Robot_ID : {robot_msg.RobotId}, Type : {robot_msg.Type}, State : {robot_msg.State}");
